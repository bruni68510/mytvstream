...
public class HTSFileInputStream extends InputStream {
	 ...
	 * Logger definition
	 */
	private static final Logger logger = LoggerFactory.getLogger(HTSFileInputStream.class);
	...
	private void open() throws IOException {
		...
		synchronized (response) {
			try {
				...
				logger.error("Timeout waiting for fileOpen", e);
			}
		}
	...
	public void close() {
		...
		synchronized (response) {
			try {
				...
				logger.error("Timeout waiting for fileClose", e);
			}
		}
	}
	...
	private void fillBuffer() {
		...
		synchronized (response) {
			try {
				...
				logger.error("Timeout waiting for fileRead", e);
			}
		}
	}
}
