...
public class HTSConnection extends Thread {
	 ...
	 * Logger definition
	 */
	private static final Logger logger = LoggerFactory.getLogger(HTSConnection.class);
    ...
    public void open(String hostname, int port) {
        ...
        try {
            ...
            logger.error("Can't open connection", ex);
    ...
    public void sendMessage(HTSMessage message, HTSResponseHandler listener) {
        ...
        try {
            ...
            logger.error("Can't transmit message", ex);
